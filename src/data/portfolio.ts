...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description_en: 'WordPress portfolio for an artist specialising in pet portraits.',
    image: '/assets/projects/menlo-artist/MENLO_COVER.png',
    tags: ['WordPress', 'Diseño Web'],
    tags_en: ['WordPress', 'Web Design'],
    category: 'Portafolio',
  ...
  },
  {
    ...
    description_en: 'WordPress website design for a sustainable architecture studio.',
    image: '/assets/projects/ARBOLA_1.jpg',
    tags: ['WordPress', 'Diseño Web'],
    tags_en: ['WordPress', 'Web Design'],
    category: 'Portafolio',
  ...
  },
  {
    ...
    description_en: 'Online second-hand designer fashion store.',
    image: '/assets/projects/mise-en-scene/MISE-EN-SCENE_COVER.png',
    tags: ['WordPress', 'Woocommerce'],
    tags_en: ['WordPress', 'WooCommerce'],
    category: 'Tienda Online',
    slug: 'mise-en-scene',
