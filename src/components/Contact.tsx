    ...
    <section id="contacto" className={cn(
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className="flex flex-wrap gap-8 md:gap-10 pt-2 lg:pt-4">

            {/* Email */}
            <a
              href="mailto:sara.m.pumariega@gmail.com"
              className="flex flex-col items-center gap-2 text-dark group"
              aria-label="Enviar email"
              title="Email"
            >
              <div className="w-16 h-16 flex items-center justify-center rounded-2xl group-hover:bg-[#e3e8e3] transition-all duration-200">
            ...
            >
              ...
              <span className="text-xs font-medium tracking-wide">Teléfono</span>
            </a>
