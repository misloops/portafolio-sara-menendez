      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className={cn('flex flex-col gap-2 lg:gap-6', 'max-w-3xl')}>
            <p className="heading-subtitle">¿Necesitas mejorar la experiencia de tu web?</p>
            <p className={cn('text-lg md:text-xl', 'leading-[1.6]', 'text-dark/75', 'max-w-3xl')}>
              Trabajo tanto en diagnóstico UX como en desarrollo de soluciones completas: arquitectura, diseño y código para que tu producto digital sea claro, útil y sostenible.
            </p>
          </div>

          <div className="w-full grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-6 pt-4 lg:pt-6">

            {/* Email */}
            <a
              href="mailto:sara.m.pumariega@gmail.com"
              className="w-full min-h-[120px] px-3 py-4 rounded-2xl border border-[#dbe3db] bg-[#ffffff66] shadow-[0_8px_24px_rgba(48,46,46,0.08)] flex flex-col items-center justify-center gap-3 text-dark transition-all duration-200 hover:bg-[#e8eee8] hover:shadow-[0_10px_28px_rgba(48,46,46,0.12)]"
              aria-label="Enviar email"
              title="Email"
            >
              <div className="w-16 h-16 flex items-center justify-center">
                <svg className="w-9 h-9 overflow-visible" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" aria-hidden="true">
            ...
            >
              ...
              <span className="text-sm font-medium tracking-wide">Teléfono</span>
            </a>
            ...
            >
              ...
              <span className="text-sm font-medium tracking-wide">CV</span>
            </a>
